...
/*
Header file provided with "Programming: Principles and Practice using C++ (second edition)"
by Bjarne Stroustup.

with some modifications by myself. Primarily used for extra range-checking on string and vector.
*/
